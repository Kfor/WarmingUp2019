      ...
      <PageHeaderWrapper content={<FormattedMessage id="form-basic-form2.basic.description" />}>
        <Card bordered={false}>
          ...
          >
            ...
            >
              {getFieldDecorator('AInvest', {
                rules: [
                  {
                    required: true,
                    message: formatMessage({
                      id: 'form-basic-form2.AInvest.required',
                    }),
                  },
                ],
              })(
            ...
            <FormItem
              {...formItemLayout}
              label={<FormattedMessage id="form-basic-form2.BInvest.label" />}
            >
              {getFieldDecorator('BInvest', {
                rules: [
                  {
                    required: true,
                    message: formatMessage({
                      id: 'form-basic-form2.BInvest.required',
                    }),
                  },
                ],
              })(
