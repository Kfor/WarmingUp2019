    ...
    return (
      <PageHeaderWrapper>
        <Card bordered={false}>
          ...
          >
            <Descriptions.Item label="总广告投入">90万</Descriptions.Item>
            <Descriptions.Item label="上轮广告投入">21万</Descriptions.Item>
            {/* <Descriptions.Item label="贷款">799万</Descriptions.Item> */}
            {/* <Descriptions.Item label="子订单">3214321432</Descriptions.Item> */}
          </Descriptions>
          <Divider
          ...
          >
            <Descriptions.Item label="A芯片">1762</Descriptions.Item>
            <Descriptions.Item label="B芯片">0</Descriptions.Item>
            <Descriptions.Item label="C芯片">211</Descriptions.Item>
            {/* <Descriptions.Item label="贷款">799万</Descriptions.Item> */}
            {/* <Descriptions.Item label="子订单">3214321432</Descriptions.Item> */}
          </Descriptions>
          <Divider
