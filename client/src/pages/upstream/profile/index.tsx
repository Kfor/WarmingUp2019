...
interface ProfileProps {
  ...
  upstreamAndprofile: BasicProfileDataType;
}
...
@connect(
  ({
    ...
    upstreamAndprofile,
    loading: loading.effects['upstreamAndprofile/fetchBasic'],
  }),
)
...
> {
  componentDidMount() {
    ...
    dispatch({
      type: 'upstreamAndprofile/fetchBasic',
    });
  }

  render() {
    const { upstreamAndprofile, loading } = this.props;
    const { basicGoods, basicProgress } = upstreamAndprofile;
