...
interface ProfileProps {
  ...
  middlestreamAndprofile: BasicProfileDataType;
}
...
@connect(
  ({
    ...
    middlestreamAndprofile,
    loading: loading.effects['middlestreamAndprofile/fetchBasic'],
  }),
)
...
> {
  componentDidMount() {
    ...
    dispatch({
      type: 'middlestreamAndprofile/fetchBasic',
    });
  }

  render() {
    const { middlestreamAndprofile, loading } = this.props;
    const { basicGoods, basicProgress } = middlestreamAndprofile;
