    ...
    return (
      <PageHeaderWrapper content={<FormattedMessage id="up-upinput.basic.description" />}>
        ...
        <Card bordered={true}>
          ...
          >
            <FormItem {...formItemLayout} label={<FormattedMessage id="up-upinput.chip1.label" />}>
            ...
            <FormItem {...formItemLayout} label={<FormattedMessage id="up-upinput.chip2.label" />}>
            ...
            <FormItem {...formItemLayout} label={<FormattedMessage id="up-upinput.chip3.label" />}>
        ...
        <Card bordered={true}>
          ...
          >
            <FormItem {...formItemLayout} label={<FormattedMessage id="up-upinput.loan.label" />}>
            ...
            <FormItem {...formItemLayout} label={<FormattedMessage id="up-upinput.repay.label" />}>
