...
const columns = [
  {
    title: <FormattedMessage id="middle-middledisplay.table.rank" defaultMessage="Rank" />,
    dataIndex: 'index',
    key: 'index',
  },
  {
  ...
  {
    title: <FormattedMessage id="middle-middledisplay.table.users" defaultMessage="Users" />,
    dataIndex: 'count',
    key: 'count',
...
const TopSearch = ({
  ...
  <Card
    ...
    title={
      <FormattedMessage
        id="middle-middledisplay.analysis.online-top-search"
      ...
      <Col sm={12} xs={24} style={{ marginBottom: 24 }}>
        <NumberInfo
          subTitle={
            <span>
              <FormattedMessage
                id="middle-middledisplay.analysis.search-users"
      ...
      <Col sm={12} xs={24} style={{ marginBottom: 24 }}>
        <NumberInfo
          subTitle={
            <span>
              <FormattedMessage
                id="middle-middledisplay.analysis.per-capita-search"
