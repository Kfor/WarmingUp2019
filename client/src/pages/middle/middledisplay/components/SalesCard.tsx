...
for (let i = 0; i < 7; i += 1) {
  rankingListData.push({
    title: formatMessage({ id: 'middle-middledisplay.analysis.test' }, { no: i }),
    total: 323234,
  });
}
...
const SalesCard = ({
  ...
  <Card loading={loading} bordered={false} bodyStyle={{ padding: 0 }}>
    <div className={styles.salesCard}>
      ...
      >
        <TabPane
          tab={<FormattedMessage id="middle-middledisplay.analysis.sales" defaultMessage="Sales" />}
          key="sales"
        >
          <Row type="flex">
            <Col xl={16} lg={12} md={12} sm={24} xs={24}>
              <div className={styles.salesBar}>
                <Bar
                  ...
                  title={
                    <FormattedMessage
                      id="middle-middledisplay.analysis.sales-trend"
            ...
            <Col xl={8} lg={12} md={12} sm={24} xs={24}>
              <div className={styles.salesRank}>
                <h4 className={styles.rankingTitle}>
                  <FormattedMessage
                    id="middle-middledisplay.analysis.sales-ranking"
          ...
          <Row>
            <Col xl={16} lg={12} md={12} sm={24} xs={24}>
              <div className={styles.salesBar}>
                <Bar
                  ...
                  title={
                    <FormattedMessage
                      id="middle-middledisplay.analysis.visits-trend"
            ...
            <Col xl={8} lg={12} md={12} sm={24} xs={24}>
              <div className={styles.salesRank}>
                <h4 className={styles.rankingTitle}>
                  <FormattedMessage
                    id="middle-middledisplay.analysis.visits-ranking"
