...
interface ProfileProps {
  ...
  downstreamAndprofile: BasicProfileDataType;
}
...
@connect(
  ({
    ...
    downstreamAndprofile,
    loading: loading.effects['downstreamAndprofile/fetchBasic'],
  }),
)
...
> {
  componentDidMount() {
    ...
    dispatch({
      type: 'downstreamAndprofile/fetchBasic',
    });
  }

  render() {
    const { downstreamAndprofile, loading } = this.props;
    const { basicGoods, basicProgress } = downstreamAndprofile;
