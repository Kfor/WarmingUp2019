...
const columns = [
  {
    title: <FormattedMessage id="down-downdisplay.table.rank" defaultMessage="Rank" />,
    dataIndex: 'index',
    key: 'index',
  },
  {
  ...
  {
    title: <FormattedMessage id="down-downdisplay.table.users" defaultMessage="Users" />,
    dataIndex: 'count',
    key: 'count',
...
const TopSearch = ({
  ...
  <Card
    ...
    title={
      <FormattedMessage
        id="down-downdisplay.analysis.online-top-search"
      ...
      <Col sm={12} xs={24} style={{ marginBottom: 24 }}>
        <NumberInfo
          subTitle={
            <span>
              <FormattedMessage
                id="down-downdisplay.analysis.search-users"
      ...
      <Col sm={12} xs={24} style={{ marginBottom: 24 }}>
        <NumberInfo
          subTitle={
            <span>
              <FormattedMessage
                id="down-downdisplay.analysis.per-capita-search"
