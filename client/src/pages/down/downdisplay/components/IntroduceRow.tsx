  ...
  <Row gutter={24} type="flex">
    <Col {...topColResponsiveProps}>
      ...
      >
        ...
        <Trend flag="down">
          <FormattedMessage id="down-downdisplay.analysis.day" defaultMessage="Daily Changes" />
    ...
    <Col {...topColResponsiveProps}>
      <ChartCard
        bordered={false}
        loading={loading}
        title={<FormattedMessage id="down-downdisplay.analysis.visits" defaultMessage="Visits" />}
        action={
          <Tooltip
            title={
              <FormattedMessage
      ...
      <ChartCard
        ...
        footer={
          <Field
            label={
              <FormattedMessage
                id="down-downdisplay.analysis.conversion-rate"
    ...
    <Col {...topColResponsiveProps}>
      <ChartCard
        ...
        title={
          <FormattedMessage
            id="down-downdisplay.analysis.operational-effect"
