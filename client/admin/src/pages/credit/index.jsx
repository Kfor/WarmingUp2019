      ...
      <PageHeaderWrapper content={<FormattedMessage id="credit.basic.description" />}>
        <Card bordered={false}>
          ...
          >
            ...
            <FormItem {...formItemLayout} label={<FormattedMessage id="credit.percentage_1.label" />}>
              {getFieldDecorator('percentage_1', {
                rules: [
                  {
                    required: true,
                    message: formatMessage({
                      id: 'credit.percentage_1.required',
                    }),
                  },
                ],
              })(
                <Input
                  placeholder={formatMessage({
                    id: 'credit.percentage_1.placeholder',
                  })}
                />,
              )}
            </FormItem>
            ...
            <FormItem {...formItemLayout} label={<FormattedMessage id="credit.percentage_2.label" />}>
              {getFieldDecorator('percentage_2', {
                rules: [
                  {
                    required: true,
                    message: formatMessage({
                      id: 'credit.percentage_2.required',
                    }),
                  },
                ],
              })(
                <Input
                  placeholder={formatMessage({
                    id: 'credit.percentage_2.placeholder',
                  })}
                />,
              )}
            </FormItem>
